classdef AtriasModel < handle
    ...
    methods
        function this = AtriasModel(axes)
            this.axes = axes;
            ...
            this.torso = RoundedSquare(0.3 + 2*R, 2*R, R, 'w', 50, this.axes);
            this.lLegA1 = RoundedSquare(0.45 + 2*r, 2*r, r, 'r', 50, this.axes);
            this.lLegA2 = RoundedSquare(0.5 + 2*r, 2*r, r, 'r', 50, this.axes);
            this.lLegB1 = RoundedSquare(0.5 + 2*r, 2*r, r, 'r', 50, this.axes);
            this.lLegB2 = RoundedSquare(0.5 + 2*r, 2*r, r, 'r', 50, this.axes);
            this.rLegA1 = RoundedSquare(0.45 + 2*r, 2*r, r, 'b', 50, this.axes);
            this.rLegA2 = RoundedSquare(0.5 + 2*r, 2*r, r, 'b', 50, this.axes);
            this.rLegB1 = RoundedSquare(0.5 + 2*r, 2*r, r, 'b', 50, this.axes);
            this.rLegB2 = RoundedSquare(0.5 + 2*r, 2*r, r, 'b', 50, this.axes);
